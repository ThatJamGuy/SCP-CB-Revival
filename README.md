...
**WARNING: CURRENTLY UNDERGOING REPOSITORY ISSUES STEMMING FROM A MISPLACED COMMIT. YOU'RE WELCOME TO TRY AND FIX IT IT IF YOU THINK YOU CAN.**
...
- [Visual Studio 2026](https://visualstudio.microsoft.com/) (Or other IDE. VS can also be auto installed via Unity Hub)
- [FMOD Studio 2.03](https://www.fmod.com/download#fmodstudio)
...
1. **FOR DIRECT LARGER CONTRIBUTIONS**
   ...
   - Use GitHub Desktop (Or Git CLI) to clone the most up to date branch from your fork of the repository. (IE. The `Unstable` branch might be more Up-To-Date than the `main` branch)
...
2. **FOR POKING AROUND**
   ...
   - To get the project onto your computer, you can either:
     ...
     - B) Use GitHub Desktop (Or Git CLI) to clone the most up to date branch from the repository. (IE. The `Unstable` branch might be more Up-To-Date than the `main` branch)
   - In Unity Hub, click **ADD > Add Project From Disk** and open the SCP-CB-Revival folder
   - Unity should handle opening the project just fine and if any FMOD related issues show up, visit [SCP-CBR-FMOD](https://github.com/ThatJamGuy/SCP-CBR-FMOD)

### 3. COMMITTING CHANGES VIA PULL REQUESTS
